# Day 01 Practice Assignments: Python Intro & Control Flow

## Objective

Apply variables, operators, loops, and conditional statements to solve introductory algorithmic challenges.
